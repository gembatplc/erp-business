        ...
        <div class="card-body">
            ...
            <form  wire:submit.prevent="add">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="code" wire:model.lazy="code" type="text" />
                    @error('code')
                      <span class="text-danger" role="alert">{{$message}}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="exchange rate" wire:model.lazy="exchange_rate" type="number" />
                    @error('exchange_rate')
                      <span class="text-danger" role="alert">{{$message}}</span>
                    @enderror
                </div>
