<div>
    ...
    @section('content')
        <div class="row">
            <div class="col-md-12">
              ...
              <div class="x_title">
                <h2>Supplier List</h2>
                <button type="button" data-toggle="modal" data-target="#addModal" class="btn btn-success btn-sm  mb-0 float-right"><i class="fa fa-plus"></i> Create Supplier</button>
                  ...
                  <table class="table  table-striped jambo_table bulk_action">
                    <thead>
                      <tr class="headings">
                        ...
                        <th class="column-title">Supplier Group</th>
    ...
    <div class="modal fade"  id="addModal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            @livewire('supplier.form-supplier')
