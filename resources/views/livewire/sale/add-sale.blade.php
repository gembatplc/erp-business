                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" id="normalinvoice">
                            ...
                            <tfoot>
                                ...
                                <tr class="hideableRow">
                                <td class="text-right" colspan="9"><b>IGT</b></td>
                                <td class="text-right">
                                ...
                                <tr>
                                <td class="text-right" colspan="9"><b>Total Tax:</b></td>
                                <td class="text-right">
                                ...
                                <tr>
                                <td class="text-right" colspan="9"><b>Shipping Cost:</b></td>
                                <td class="text-right">
                                ...
                                <tr>
                                <td class="text-right" colspan="9"><b>Due:</b></td>
                                <td class="text-right">
                                ...
                                <td colspan="8" class="text-right"><b>Change:</b></td>
                                <td class="text-right">
