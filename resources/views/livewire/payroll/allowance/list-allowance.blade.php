        ...
        <div class="row">
            <div class="col-md-12">
              ...
              <div class="x_title">
                ...
                <button type="button" data-toggle="modal" data-target="#addModal" class="btn btn-success btn-sm  mb-0 float-right"><i class="fa fa-plus"></i> Create Allowance</button>
                  ...
                  <table class="table table-bordered table-striped jambo_table bulk_action">
                    <thead>
                      <tr class="headings">
                        ...
                        <th class="column-title">Allowance Name</th>
                        <th class="column-title">Allowance Month</th>
                ...
                <div class="card-body">
                    ...
                    <form>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="font-weight-bold text-dark">Allowance Month</label>
                                    <input class="form-control"  type="month"/>
                                    @error('allowance_month')
                                      <span class="text-danger" role="alert">{{$message}}</span>
                                    @enderror
                                </div>
                            </div>
